...
function Header(){
    ...
    return(
        <>
        {showMenu && <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                        ...
                        <Navbar icon="fas fa-fw fa-cog" topic="Components" id="collapseTwo" className="collapseTwo" label="collapseTwo" target="#collapseTwo">
                            ...
                            <Link to="/posts">
                            <Connector className="collapse-item" label="Posts" />
                            </Link>
                        </Navbar> 
                        <div className="sidebar-heading">
                            Addons
                        ...
                        <Navbar icon="fas fa-fw fa-folder" topic="Pages" id="collapsePages" className="collapsePages" label="collapsePages" target="#collapsePages">
                            ...
                            <Link to="/email">
                            <Connector className="collapse-item" label="Email" />
                            </Link>
                        ...
                        <div className="sidebar-card">
                            ...
                            <Connector className="btn btn-success btn-sm"  label="Upgrade to Pro!" />
                        </div>
                    </ul>
        }
        <div className="row">
